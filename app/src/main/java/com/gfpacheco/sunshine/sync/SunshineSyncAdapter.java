...
import com.gfpacheco.sunshine.MainActivity;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void notifyWeather() {
        ...
        if (prefs.getBoolean(context.getString(R.string.pref_enable_notification_key), true) &&
                System.currentTimeMillis() - lastSync >= 86400000) {
            // Last sync was more than 1 day ago, let's send a notification with the weather.
            String locationQuery = Utils.getLocationPreference(context);
            ...
            if (cursor.moveToFirst()) {
                ...
                String contentText = String.format(context.getString(R.string.format_notification),
                        desc,
                        Utils.formatTemperature(context, high, isMetric),
                        Utils.formatTemperature(context, low, isMetric)
                );
